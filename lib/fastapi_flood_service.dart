...
class FastApiFloodService {
  ...
  static String baseUrl = 'http://127.0.0.1:8082';
  ...
  static Future<List<String>> getAreas() async {
    final res = await http.get(Uri.parse('$baseUrl/areas'), headers: _jsonHeaders);
  ...
  static Future<Map<String, dynamic>> predict(String area, {String? date}) async {
