...
def build_and_save_map(start_region_name: str, routes: list, out_file: str):
    ...
    folium.TileLayer("cartodbpositron", name="Carto Positron",
                     attr="© OpenStreetMap contributors © CARTO").add_to(m)
    folium.TileLayer("cartodbdark_matter", name="Carto Dark",
                     attr="© OpenStreetMap contributors © CARTO").add_to(m)
    ...
    folium.TileLayer("Stamen Toner", name="Stamen Toner",
                     attr="Map tiles by Stamen Design, CC BY 3.0 — Map data © OpenStreetMap").add_to(m)
    folium.TileLayer("Stamen Watercolor", name="Stamen Watercolor",
                     attr="Map tiles by Stamen Design, CC BY 3.0 — Map data © OpenStreetMap").add_to(m)
    ...
    # Risk-colored road layer (sampled)
    GeoJson(
        data=edges_gdf_sampled.__geo_interface__,
        name="Road risk (sampled)",
    ...
    # Region markers (hover + color by risk)
